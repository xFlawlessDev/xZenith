...
1. Go to [Releases](https://github.com/xFlawlessDev/xZenith/releases/latest)
...
1. Download the latest version from [Releases](https://github.com/xFlawlessDev/xZenith/releases/latest)
